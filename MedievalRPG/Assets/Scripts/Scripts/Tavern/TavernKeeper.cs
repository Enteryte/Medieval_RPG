...
public class TavernKeeper : MonoBehaviour, IInteractable
{
    ...
    public void Interact(Transform transform)
    {
        ...
        if (neededForMission)
        {
            Debug.Log("ZUJHKL÷111111111111111111111");
            ...
            if (currCorrTask.dialogToPlayAfterInteracted != null && !currCorrTask.dialogToPlayAfterInteracted.alreadyPlayedCutscene)
            {
                ...
                Debug.Log("ZUJHKL÷222222222222222222222");
            }
            else
            {
                ...
                Debug.Log("ZUJHKL÷3333333333333333333333333333");
            }
        ...
        else if (!neededForMission)
        {
            ...
            Debug.Log("ZUJHKL÷444444444444444444444444444444");
        }
