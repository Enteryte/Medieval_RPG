...
Shader "TriForge/Winter Forest/Leaf - No Translucency"
{
	Properties
	{
		...
		[ASEEnd]_SnowDelay("Snow Delay", Range( 0 , 5)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 texCoord288 = inputMesh.uv2.xy * temp_output_401_0 + float2( 0,0 );
				...
				float4 localWorldVar2_g2 = float4( ase_worldPos , 0.0 );
				(localWorldVar2_g2).xyz = GetCameraRelativePositionWS((localWorldVar2_g2).xyz);
				float4 transform2_g2 = mul(GetWorldToObjectMatrix(),localWorldVar2_g2);
				float2 WorldSpaceUv9_g2 = (( transform2_g2 / ( -100.0 * ( 1.0 * _WindNoiseScale ) ) )).xz;
				float2 texCoord12_g2 = inputMesh.uv1.xy * float2( 0,0 ) + WorldSpaceUv9_g2;
				...
				float3 rotatedValue42_g2 = RotateAroundAxis( float3( 0,0,0 ), inputMesh.positionOS, WindDirection41_g2, WindRotation32_g2 );
				float3 WindOutput394 = ( ( rotatedValue42_g2 - inputMesh.positionOS ) * TFW_EnableWind );
				float3 break358 = ( 0.15 * WindOutput394 );
				float2 texCoord363 = inputMesh.uv2.xy * temp_output_401_0 + float2( 0,0 );
				...
				float3 LeafWind216 = ( ( _LeafFlutterStrength * ( TFW_LeafFlutterStrength * appendResult360 ) ) * inputMesh.ase_color.g );
						...
						)
			{
				...
				float3 tanNormal199 = NormalMap220;
				...
				float saferPower431 = abs( ( ( 1.0 - packedInput.ase_color.r ) * 3.0 ) );
				...
				surfaceDescription.Albedo = lerpResult187.rgb;
				surfaceDescription.Normal = NormalMap220;
				...
				surfaceDescription.Smoothness = ( SmoothnessMap223 * _Smoothness );
				surfaceDescription.Occlusion = VertexAO437;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 temp_output_401_0 = ( float2( 1,1 ) * 0.2 );
				float2 texCoord288 = inputMesh.ase_texcoord2.xy * temp_output_401_0 + float2( 0,0 );
				float2 panner283 = ( 0.5 * _Time.y * float2( 0.2,0 ) + texCoord288);
				float temp_output_457_0 = ( TFW_LeafFlutterScale * _LeafFlutterScale );
				float simplePerlin2D282 = snoise( panner283*temp_output_457_0 );
				float LeafXZNoise390 = ( simplePerlin2D282 * _SidewaysForce );
				...
				float4 transform2_g2 = mul(GetWorldToObjectMatrix(),localWorldVar2_g2);
				float2 WorldSpaceUv9_g2 = (( transform2_g2 / ( -100.0 * ( 1.0 * _WindNoiseScale ) ) )).xz;
				float2 texCoord12_g2 = inputMesh.ase_texcoord1.xy * float2( 0,0 ) + WorldSpaceUv9_g2;
				float2 temp_cast_1 = (texCoord12_g2.x).xx;
				float2 panner13_g2 = ( 1.0 * _Time.y * ( float2( 0.12,0 ) * WindSpeed19_g2 ) + temp_cast_1);
				float simplePerlin3D11_g2 = snoise( float3( panner13_g2 ,  0.0 )*0.5 );
				float MainWindBending86_g2 = simplePerlin3D11_g2;
				...
				float3 WindOutput394 = ( ( rotatedValue42_g2 - inputMesh.positionOS ) * TFW_EnableWind );
				float3 break358 = ( 0.15 * WindOutput394 );
				float2 texCoord363 = inputMesh.ase_texcoord2.xy * temp_output_401_0 + float2( 0,0 );
				float2 panner364 = ( 0.6 * _Time.y * float2( 0,0.34 ) + texCoord363);
				float simplePerlin2D365 = snoise( panner364*temp_output_457_0 );
				simplePerlin2D365 = simplePerlin2D365*0.5 + 0.5;
				float LeafYNoise389 = ( simplePerlin2D365 * _DownwardForce );
...
/*ASEBEGIN
Version=18921
241;155;1135;556;4429.221;651.8961;1.3;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;404;-2973.896,-1201.002;Inherit;False;Property;_NormalScale;Normal Scale;3;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;238;-2804.035,-2012.634;Inherit;False;661.3553;1125.12;Comment;11;179;229;235;222;223;221;180;220;186;467;468;Texture Samples;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;186;-2743.136,-1248.325;Inherit;True;Property;_Normal;Normal;2;0;Create;True;0;0;0;False;0;False;-1;None;6e99ed2906de2ed4b96fded5eca4347c;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;428;-3803.657,3793.452;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;77;-3780.802,2939.128;Inherit;False;Property;_WindSpeed;Wind Speed;8;0;Create;True;0;0;0;False;0;False;1;2;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;458;-3463.134,610.7793;Inherit;False;Property;_LeafFlutterScale;Leaf Flutter Scale;11;0;Create;True;0;0;0;False;0;False;1;1;0.1;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;6;-3696.023,3072.537;Inherit;False;Property;_WindNoiseScale;Wind Noise Scale;9;0;Create;True;0;0;0;False;0;False;1;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;237;-5475.938,-744.1594;Inherit;False;3258.046;801.0634;;28;227;209;202;424;213;191;425;214;426;204;193;225;205;194;190;189;199;439;441;442;443;444;422;462;463;464;465;466;Snow Mask;1,1,1,1;0;0
Node;AmplifyShaderEditor.OneMinusNode;451;-3553.775,3761.784;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;220;-2391.266,-1243.536;Inherit;False;NormalMap;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;465;-5412.826,-81.38245;Inherit;False;Property;_SnowDelay;Snow Delay;18;0;Create;True;0;0;0;False;0;False;0;0;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;422;-5444.837,-685.1123;Inherit;False;220;NormalMap;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;189;-5416.276,-338.4487;Inherit;False;Property;_SnowMaxAmount;Snow Max Amount;14;0;Create;True;0;0;0;False;0;False;2;2;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;464;-5095.152,-76.49786;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;356;-2858.497,577.532;Inherit;False;Property;_SidewaysForce;SidewaysForce;13;0;Create;True;0;0;0;False;0;False;1.5;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;362;-2847.866,993.5286;Inherit;False;Property;_DownwardForce;DownwardForce;12;0;Create;True;0;0;0;False;0;False;0.5;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;466;-4889.91,-136.5676;Inherit;False;Global;TFW_SnowAmount;TFW_SnowAmount;19;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;425;-5161.412,-532.7322;Inherit;False;Constant;_Float2;Float 2;16;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;463;-4997.034,-336.5118;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;2;False;3;FLOAT;0;False;4;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;426;-5286.495,-455.8022;Inherit;False;Property;_SnowNormalsInfluence;Snow Normals Influence;16;0;Create;True;0;0;0;False;0;False;0;0.744;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;180;-2746.346,-1470.3;Inherit;True;Property;_MaskMap;Mask Map;4;0;Create;True;0;0;0;False;0;False;-1;None;033274e0cc67f1340995a576c84dec92;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WorldNormalVector;199;-5200.036,-681.3384;Inherit;False;True;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;462;-4738.792,-314.5255;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;221;-2388.651,-1486.684;Inherit;False;SnowMask;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;424;-4971.875,-527.5712;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;190;-4617.314,-578.6746;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;225;-4516.081,-225.5254;Inherit;False;221;SnowMask;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;388;-3226.934,1491.087;Inherit;False;389;LeafYNoise;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;194;-4670.726,-446.7243;Inherit;False;Property;_SnowMaskSharpness;Snow Mask Sharpness;15;0;Create;True;0;0;0;False;0;False;1.5;1.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;205;-4452.094,-88.96798;Inherit;False;Constant;_Float4;Float 4;15;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;214;-4193.699,-101.3515;Inherit;False;Constant;_Float0;Float 0;17;0;Create;True;0;0;0;False;0;False;1.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;193;-4362.066,-579.5233;Inherit;True;True;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;204;-4265.611,-221.6592;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;387;-2766.747,1420.37;Inherit;False;Global;TFW_LeafFlutterStrength;TFW_LeafFlutterStrength;12;0;Create;True;0;0;0;False;0;False;1;0.6;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;439;-3410.321,-249.8037;Inherit;False;437;VertexAO;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;444;-3380.321,-130.8038;Inherit;False;Property;_SnowVertexAOInfluence;Snow Vertex AO Influence;17;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;443;-3292.321,-350.8034;Inherit;False;Constant;_Float11;Float 11;19;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;191;-4041.026,-583.0574;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;213;-3984.192,-221.3357;Inherit;False;True;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;414;-2532.292,1318.868;Inherit;False;Property;_LeafFlutterStrength;Leaf Flutter Strength;10;0;Create;True;0;0;0;False;0;False;0;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;202;-3782.618,-623.4357;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;442;-3100.32,-314.8034;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;38;-2646.86,2973.299;Inherit;False;Property;_WindStrength;Wind Strength;7;0;Create;True;0;0;0;False;0;False;0.3;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;467;-2751.41,-1711.937;Inherit;False;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;441;-3092.32,-510.8036;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;179;-2777.523,-1964.633;Inherit;True;Property;_MainTex;Albedo;1;0;Create;False;0;0;0;False;0;False;-1;None;7e59775cae4cc8e4c8470ab7c8bae992;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SaturateNode;209;-2908.034,-608.6376;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;468;-2489.827,-1733.967;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;223;-2387.344,-1331.121;Inherit;False;SmoothnessMap;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;227;-2752.321,-614.9926;Inherit;False;SnowBlendMask;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;229;-2385.967,-1962.392;Inherit;False;AlbedoMap;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;230;-89.11208,-519.9927;Inherit;False;229;AlbedoMap;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;218;-55.46991,681.7409;Inherit;False;215;MainWind;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;217;-58.46991,594.7409;Inherit;False;216;LeafWind;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;235;-2391.08,-1829.054;Inherit;False;OpacityMap;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;222;-2389.958,-1406.942;Inherit;False;TranslucencyMap;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;236;105.227,433.9744;Inherit;False;235;OpacityMap;1;0;OBJECT;;False;1;FLOAT;0
...
WireConnection;469;0;187;0
WireConnection;469;1;461;0
WireConnection;469;7;211;0
WireConnection;469;8;438;0
WireConnection;469;9;236;0
WireConnection;469;11;219;0
ASEEND*/
//CHKSM=C96D4BE0FB91BB4F7D6C7E7F87CCE0969F3D7462