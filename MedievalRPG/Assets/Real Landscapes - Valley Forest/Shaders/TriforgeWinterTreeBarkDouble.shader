...
Shader "TriForge/Winter Forest/Bark Double"
{
	Properties
	{
		...
		[ASEEnd]_BlendStrength("Blend Strength", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float4 localWorldVar2_g3 = float4( ase_worldPos , 0.0 );
				(localWorldVar2_g3).xyz = GetCameraRelativePositionWS((localWorldVar2_g3).xyz);
				float4 transform2_g3 = mul(GetWorldToObjectMatrix(),localWorldVar2_g3);
				float2 WorldSpaceUv9_g3 = (( transform2_g3 / ( -100.0 * ( 1.0 * _WindNoiseScale ) ) )).xz;
				float2 texCoord12_g3 = inputMesh.uv1.xy * float2( 0,0 ) + WorldSpaceUv9_g3;
				...
				float3 rotatedValue42_g3 = RotateAroundAxis( float3( 0,0,0 ), inputMesh.positionOS, WindDirection41_g3, WindRotation32_g3 );
				float3 MainWind168 = ( ( saturate( pow( saferPower68 , 2.34 ) ) * ( ( rotatedValue42_g3 - inputMesh.positionOS ) * TFW_EnableWind ) ) * _WindStrength );
						...
						)
			{
				...
				float saferPower439 = abs( normalizedWorldNormal.y );
				...
				float saferPower189 = abs( saturate( ( worldNormal187.y * temp_output_429_0 ) ) );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float4 transform2_g3 = mul(GetWorldToObjectMatrix(),localWorldVar2_g3);
				float2 WorldSpaceUv9_g3 = (( transform2_g3 / ( -100.0 * ( 1.0 * _WindNoiseScale ) ) )).xz;
				float2 texCoord12_g3 = inputMesh.ase_texcoord1.xy * float2( 0,0 ) + WorldSpaceUv9_g3;
				float2 temp_cast_1 = (texCoord12_g3.x).xx;
				float2 panner13_g3 = ( 1.0 * _Time.y * ( float2( 0.12,0 ) * WindSpeed19_g3 ) + temp_cast_1);
				float simplePerlin3D11_g3 = snoise( float3( panner13_g3 ,  0.0 )*0.5 );
				float MainWindBending86_g3 = simplePerlin3D11_g3;
...
/*ASEBEGIN
Version=18921
1920;0;1920;1019;3035.737;5107.41;1;True;False
...
Node;AmplifyShaderEditor.TexturePropertyNode;376;-4981.083,-2826.07;Inherit;True;Property;_SnowNormal;Snow Normal;17;0;Create;False;0;0;0;False;0;False;None;None;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.CommentaryNode;256;-4533.839,-1741.936;Inherit;False;2135.386;650.1171;;17;188;190;189;192;181;179;180;182;184;183;185;187;186;428;429;439;455;Snow Mask;0,0.7479331,1,1;0;0
...
Node;AmplifyShaderEditor.WorldNormalVector;179;-4581.126,-1694.81;Inherit;False;True;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;428;-4510.098,-1351.035;Inherit;False;Global;TFW_SnowAmount;TFW_SnowAmount;22;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;439;-4247.172,-1642.992;Inherit;False;True;2;0;FLOAT;0;False;1;FLOAT;5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;184;-4107.947,-1175.693;Inherit;False;178;SnowNormal;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;183;-4142.323,-1284.91;Inherit;False;299;NormalBottomBlend;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LerpOp;185;-3837.648,-1235.558;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.WorldNormalVector;187;-3678.533,-1569.391;Inherit;True;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;188;-3413.416,-1532.346;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;455;-3122.127,-1538.985;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;189;-2952.778,-1404.343;Inherit;True;True;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;192;-2643.888,-1407.815;Inherit;False;SnowBlendMask;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;200;-845.9055,-1855.405;Inherit;False;FinalAlbedo;-1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;186;-3619.001,-1198.328;Inherit;False;NormalBlend;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
WireConnection;443;0;201;0
WireConnection;443;1;202;0
WireConnection;443;7;216;0
WireConnection;443;8;214;0
WireConnection;443;11;171;0
ASEEND*/
//CHKSM=BE4CED94BCF4C0328E44911E73E16D4AE68E8A81