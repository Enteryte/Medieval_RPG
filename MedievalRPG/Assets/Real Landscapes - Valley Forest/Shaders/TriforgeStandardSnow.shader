...
Shader "TriForge/Winter Forest/Standard Snow"
{
	Properties
	{
		...
		[ASEEnd]_Color1("Color", Color) = (1,1,1,0)
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 BaseColor27 = ( tex2DNode1 * _Color1 );
				float2 _Vector0 = float2(2,2);
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float4 triplanar101 = TriplanarSampling101( _SnowAlbedo, packedInput.ase_texcoord6.xyz, packedInput.ase_normal, 1.0, _Vector0, 1.0, 0 );
				float4 SnowColor28 = triplanar101;
				float2 uv_Normal = packedInput.ase_texcoord5.xy * _Normal_ST.xy + _Normal_ST.zw;
				float3 Normal12 = UnpackNormalScale( tex2D( _Normal, uv_Normal ), 1.0f );
				...
				float3 triplanar102 = TriplanarSampling102( _SnowNormal, packedInput.ase_texcoord6.xyz, packedInput.ase_normal, 1.0, _Vector0, 1.0, 0 );
				...
				float saferPower145 = max( normalizedWorldNormal.y , 0.0001 );
				...
				float saferPower82 = max( ( worldNormal22.y * temp_output_143_0 ) , 0.0001 );
				...
				float2 uv_MetallicRSmoothnessA = packedInput.ase_texcoord5.xy * _MetallicRSmoothnessA_ST.xy + _MetallicRSmoothnessA_ST.zw;
				...
				float2 uv_AmbientOcclusionG = packedInput.ase_texcoord5.xy * _AmbientOcclusionG_ST.xy + _AmbientOcclusionG_ST.zw;
				...
				surfaceDescription.Albedo = ColorBlend36.xyz;
				surfaceDescription.Normal = NormalBlend29;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = MetallicBlend66;
				...
				surfaceDescription.Smoothness = SmoothnessBlend56;
				surfaceDescription.Occlusion = AmbientOcclusionBlend46;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 triplanar101 = TriplanarSampling101( _SnowAlbedo, packedInput.ase_texcoord3.xyz, packedInput.ase_normal, 1.0, _Vector0, 1.0, 0 );
				float4 SnowColor28 = triplanar101;
				...
				float3x3 objectToTangent = float3x3(packedInput.ase_tangent.xyz, ase_vertexBitangent, packedInput.ase_normal);
				float3 triplanar102 = TriplanarSampling102( _SnowNormal, packedInput.ase_texcoord3.xyz, packedInput.ase_normal, 1.0, _Vector0, 1.0, 0 );
				float3 tanTriplanarNormal102 = mul( objectToTangent, triplanar102 );
				float3 SnowNormal14 = tanTriplanarNormal102;
				...
				float2 uv_MetallicRSmoothnessA = packedInput.ase_texcoord.xy * _MetallicRSmoothnessA_ST.xy + _MetallicRSmoothnessA_ST.zw;
				float4 tex2DNode4 = tex2D( _MetallicRSmoothnessA, uv_MetallicRSmoothnessA );
				float BaseMetallic49 = tex2DNode4.r;
				float lerpResult63 = lerp( ( BaseMetallic49 * _Metallic ) , 0.0 , SnowBlendMask25);
				float MetallicBlend66 = lerpResult63;
				...
				float2 uv_AmbientOcclusionG = packedInput.ase_texcoord.xy * _AmbientOcclusionG_ST.xy + _AmbientOcclusionG_ST.zw;
				float AmbientOcclusion39 = tex2D( _AmbientOcclusionG, uv_AmbientOcclusionG ).g;
				float lerpResult44 = lerp( AmbientOcclusion39 , 1.0 , SnowBlendMask25);
				float AmbientOcclusionBlend46 = lerpResult44;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_MetallicRSmoothnessA = packedInput.ase_texcoord3.xy * _MetallicRSmoothnessA_ST.xy + _MetallicRSmoothnessA_ST.zw;
				float4 tex2DNode4 = tex2D( _MetallicRSmoothnessA, uv_MetallicRSmoothnessA );
		...
		Pass
		{
				...
				)
			{
				...
				float3 ase_vertexBitangent = packedInput.ase_texcoord8.xyz;
				float3x3 objectToTangent = float3x3(packedInput.ase_tangent.xyz, ase_vertexBitangent, packedInput.ase_normal);
				float3 triplanar102 = TriplanarSampling102( _SnowNormal, packedInput.ase_texcoord9.xyz, packedInput.ase_normal, 1.0, _Vector0, 1.0, 0 );
				float3 tanTriplanarNormal102 = mul( objectToTangent, triplanar102 );
				float3 SnowNormal14 = tanTriplanarNormal102;
				float3 normalizedWorldNormal = normalize( ase_worldNormal );
				float saferPower145 = max( normalizedWorldNormal.y , 0.0001 );
				...
				#endif
				float BaseSmoothness48 = staticSwitch142;
				float4 triplanar101 = TriplanarSampling101( _SnowAlbedo, packedInput.ase_texcoord9.xyz, packedInput.ase_normal, 1.0, _Vector0, 1.0, 0 );
				float SnowSmoothness52 = triplanar101.w;
				float3 tanToWorld0 = float3( ase_worldTangent.x, ase_worldBitangent.x, ase_worldNormal.x );
				float3 tanToWorld1 = float3( ase_worldTangent.y, ase_worldBitangent.y, ase_worldNormal.y );
				float3 tanToWorld2 = float3( ase_worldTangent.z, ase_worldBitangent.z, ase_worldNormal.z );
		...
		Pass
		{
						...
						)
			{
				...
				float2 _Vector0 = float2(2,2);
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float4 triplanar101 = TriplanarSampling101( _SnowAlbedo, packedInput.ase_texcoord8.xyz, packedInput.ase_normal, 1.0, _Vector0, 1.0, 0 );
				float4 SnowColor28 = triplanar101;
				...
				float3x3 objectToTangent = float3x3(packedInput.ase_tangent.xyz, ase_vertexBitangent, packedInput.ase_normal);
				float3 triplanar102 = TriplanarSampling102( _SnowNormal, packedInput.ase_texcoord8.xyz, packedInput.ase_normal, 1.0, _Vector0, 1.0, 0 );
				float3 tanTriplanarNormal102 = mul( objectToTangent, triplanar102 );
				float3 SnowNormal14 = tanTriplanarNormal102;
				float3 normalizedWorldNormal = normalize( normalWS );
				float saferPower145 = max( normalizedWorldNormal.y , 0.0001 );
				...
				float2 uv_MetallicRSmoothnessA = packedInput.ase_texcoord7.xy * _MetallicRSmoothnessA_ST.xy + _MetallicRSmoothnessA_ST.zw;
				float4 tex2DNode4 = tex2D( _MetallicRSmoothnessA, uv_MetallicRSmoothnessA );
				float BaseMetallic49 = tex2DNode4.r;
				float lerpResult63 = lerp( ( BaseMetallic49 * _Metallic ) , 0.0 , SnowBlendMask25);
				float MetallicBlend66 = lerpResult63;
				...
				float2 uv_AmbientOcclusionG = packedInput.ase_texcoord7.xy * _AmbientOcclusionG_ST.xy + _AmbientOcclusionG_ST.zw;
				float AmbientOcclusion39 = tex2D( _AmbientOcclusionG, uv_AmbientOcclusionG ).g;
				float lerpResult44 = lerp( AmbientOcclusion39 , 1.0 , SnowBlendMask25);
				float AmbientOcclusionBlend46 = lerpResult44;
...
/*ASEBEGIN
Version=18908
1920;6;1920;1013;4537.665;2143.493;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;50;-4153.494,-1862.002;Inherit;False;675.7842;954.942;;9;1;4;5;2;39;12;49;157;158;Base Textures;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.TriplanarNode;102;-4146.867,-451.2142;Inherit;True;Spherical;Object;True;Snow Normal;_SnowNormal;bump;7;None;Mid Texture 1;_MidTexture1;white;-1;None;Bot Texture 1;_BotTexture1;white;-1;None;Snow Normal;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;1;-4103.061,-1812.002;Inherit;True;Property;_Albedo;Albedo;0;0;Create;True;0;0;0;False;0;False;-1;None;dce506e5e22004944a0cbe16380bfcd9;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;158;-3807.665,-1715.493;Inherit;False;Property;_Color1;Color;11;0;Create;False;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TriplanarNode;101;-4154.089,-673.7489;Inherit;True;Spherical;Object;False;Snow Albedo;_SnowAlbedo;white;8;None;Mid Texture 0;_MidTexture0;white;-1;None;Bot Texture 0;_BotTexture0;white;-1;None;Snow Albedo;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;157;-3598.665,-1810.493;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;27;-3399.502,-1815.402;Inherit;False;BaseColor;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;146;4;70;0
WireConnection;146;7;68;0
WireConnection;146;8;69;0
ASEEND*/
//CHKSM=9ED41E655AA64543983F5917321CFB40220BE218