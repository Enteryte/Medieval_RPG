	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv3_BottomAlbedo = packedInput.uv2.xy * _BottomAlbedo_ST.xy + _BottomAlbedo_ST.zw;
				...
				float2 uv3_BottomNormal = packedInput.uv2.xy * _BottomNormal_ST.xy + _BottomNormal_ST.zw;
				...
				float2 uv3_BottomMask = packedInput.uv2.xy * _BottomMask_ST.xy + _BottomMask_ST.zw;
...
/*ASEBEGIN
Version=19001
1987;58;1920;923;6044.421;6221.82;2.656041;True;True
...
ASEEND*/
//CHKSM=4A01167B6A20D9CE45A974C420838B90A461F4E8