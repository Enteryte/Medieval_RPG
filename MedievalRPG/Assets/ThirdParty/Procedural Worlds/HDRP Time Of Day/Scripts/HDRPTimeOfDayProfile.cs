...
namespace ProceduralWorlds.HDRPTOD
{
    ...
    public enum TimeOfDayExposureMode { Fixed, Automatic }
    public enum AntiAliasingQuality { Low, Medium, High }
    public enum CompensationMode { DayOnly, NightOnly, Both }
    ...
    public class TimeOfDayProfileData
    {
        ...
        public float m_ambientCompensationAmount = 2f;
        ...
        public bool ReturnFromWeather(HDRPTimeOfDayComponents components, bool isDay, bool overrideLightSource, float time, float duration)
        {
            ...
            if (ValidateAdvancedLighting())
            {
                ...
                components.m_indirectLightingController.indirectDiffuseLightingMultiplier.value = LerpFloat(m_startingData.m_ambientIntensity.Evaluate(m_lastTimeOfDayValue), m_ambientIntensity.Evaluate(time) * m_ambientIntensityMultiplier, duration);
            ...
            if (ValidateFog())
            {
                ...
                components.m_fog.meanFreePath.value = LerpFloat(m_startingData.m_fogDistance.Evaluate(m_lastTimeOfDayValue),m_fogDistance.Evaluate(time) / m_globalFogMultiplier, duration);
            ...
            if (ValidateClouds())
            {
                ...
                switch (m_cloudLayerAChannel)
                {
                    ...
                    {
                        components.m_cloudLayer.layerA.opacityG.value = LerpFloat(m_startingData.m_cloudLayerAOpacityR.Evaluate(m_lastTimeOfDayValue), m_cloudLayerAOpacityR.Evaluate(time), duration);
                    ...
                    {
                        components.m_cloudLayer.layerA.opacityB.value = LerpFloat(m_startingData.m_cloudLayerAOpacityR.Evaluate(m_lastTimeOfDayValue), m_cloudLayerAOpacityR.Evaluate(time), duration);
                        components.m_cloudLayer.layerA.opacityR.value = 0f;
                        components.m_cloudLayer.layerA.opacityG.value = 0f;
                        components.m_cloudLayer.layerA.opacityA.value = 0f;
                        break;
                    ...
                    {
                        components.m_cloudLayer.layerA.opacityA.value = LerpFloat(m_startingData.m_cloudLayerAOpacityR.Evaluate(m_lastTimeOfDayValue), m_cloudLayerAOpacityR.Evaluate(time), duration);
                        components.m_cloudLayer.layerA.opacityR.value = 0f;
                        components.m_cloudLayer.layerA.opacityG.value = 0f;
                        components.m_cloudLayer.layerA.opacityB.value = 0f;
                        break;
                ...
                switch (m_cloudLayerBChannel)
                {
                    ...
                    case CloudLayerChannelMode.G:
                    {
                        components.m_cloudLayer.layerB.opacityG.value = LerpFloat(m_startingData.m_cloudLayerBOpacityR.Evaluate(m_lastTimeOfDayValue), m_cloudLayerBOpacityR.Evaluate(time), duration);
                    ...
                    case CloudLayerChannelMode.B:
                    {
                        components.m_cloudLayer.layerB.opacityB.value = LerpFloat(m_startingData.m_cloudLayerBOpacityR.Evaluate(m_lastTimeOfDayValue), m_cloudLayerBOpacityR.Evaluate(time), duration);
                        components.m_cloudLayer.layerB.opacityR.value = 0f;
                        components.m_cloudLayer.layerB.opacityG.value = 0f;
                        components.m_cloudLayer.layerB.opacityA.value = 0f;
                        break;
                    ...
                    case CloudLayerChannelMode.A:
                    {
                        components.m_cloudLayer.layerB.opacityA.value = LerpFloat(m_startingData.m_cloudLayerBOpacityR.Evaluate(m_lastTimeOfDayValue), m_cloudLayerBOpacityR.Evaluate(time), duration);
                        components.m_cloudLayer.layerB.opacityR.value = 0f;
                        components.m_cloudLayer.layerB.opacityG.value = 0f;
                        components.m_cloudLayer.layerB.opacityB.value = 0f;
                        break;
        ...
        public void ApplyExposure(HDRPTimeOfDayComponents components, bool isDay, float time, float duration, OverrideDataInfo overrideData = null, bool isReturningWeather = false)
        {
            ...
            switch (m_exposureMode)
            {
                ...
                {
                    components.m_exposure.mode.value = ExposureMode.AutomaticHistogram;
                    components.m_exposure.limitMin.value = m_autoExposureSettings.m_mixMaxLimit.x;
                    components.m_exposure.limitMax.value = m_autoExposureSettings.m_mixMaxLimit.y;
                    components.m_exposure.histogramPercentages.value = m_autoExposureSettings.m_histogramPercentage;
                    components.m_exposure.adaptationSpeedDarkToLight.value = m_autoExposureSettings.m_adaptionSpeed.x;
                    components.m_exposure.adaptationSpeedLightToDark.value = m_autoExposureSettings.m_adaptionSpeed.y;
                    break;
                }
                case TimeOfDayExposureMode.Fixed:
                {
                    components.m_exposure.mode.value = ExposureMode.Fixed;
        ...
        public static void CopySettings(TimeOfDayProfileData copyTo, TimeOfDayProfileData copyFrom)
        {
            if (copyTo != null && copyFrom != null)
            {
                ...
                copyTo.m_ambientCompensationAmount = copyFrom.m_ambientCompensationAmount;
        ...
        {
            components.m_physicallyBasedSky.spaceEmissionMultiplier.value = m_starIntensity.Evaluate(time);
            if (m_rotateStars)
            {
                components.m_physicallyBasedSky.spaceRotation.value += new Vector3(0.001f, 0.002f, 0.001f);
            }
        }
        ...
        public void ApplySunSettings(HDAdditionalLightData lightData, float time, bool isDay, bool overrideSource, OverrideDataInfo overrideData)
        {
            ...
            if (!overrideSource)
            {
                if (isDay)
                {
                    ...
                    lightData.shadowDimmer = Mathf.Clamp01(m_sunShadowDimmer.Evaluate(time));
                }
                else
                {
                    ...
                    lightData.shadowDimmer = Mathf.Clamp01(m_moonShadowDimmer.Evaluate(time));
                }
            }
        ...
        public void ApplyAdvancedLighting(HDRPTimeOfDayComponents components, bool isDay, float time, OverrideDataInfo overrideData)
        {
            bool transitionComplete = overrideData.m_transitionTime < 1f;
            //SSGI
            ...
            components.m_microShadowing.opacity.value = Mathf.Clamp01(m_microShadowOpacity.Evaluate(time));
            //Ambient
            ...
            components.m_exposure.compensation.overrideState = true;
            if (m_useSSGI && m_ambientSSGICompensation)
            {
                switch (m_compensationMode)
                {
                    ...
                    {
                        components.m_exposure.compensation.value = m_ambientCompensationAmount;
                        break;
                    }
                    case CompensationMode.DayOnly:
                    {
                        ...
                        {
                            components.m_exposure.compensation.value = 0f;
                        }
                        break;
                    }
            ...
            if (!overrideData.m_isInVolue)
            {
                if (transitionComplete)
                {
                    components.m_indirectLightingController.indirectDiffuseLightingMultiplier.value = Mathf.Lerp(components.m_indirectLightingController.indirectDiffuseLightingMultiplier.value, ambientIntensity * m_ambientIntensityMultiplier, overrideData.m_transitionTime);
                ...
                {
                    components.m_indirectLightingController.indirectDiffuseLightingMultiplier.value = ambientIntensity * m_ambientIntensityMultiplier;
            ...
            else
            {
                if (overrideData.m_settings.m_ambientIntensity.overrideState)
                {
                    if (transitionComplete)
                    {
                        components.m_indirectLightingController.indirectDiffuseLightingMultiplier.value = Mathf.Lerp(components.m_indirectLightingController.indirectDiffuseLightingMultiplier.value, overrideAmbientIntensity * m_ambientIntensityMultiplier, overrideData.m_transitionTime);
                    }
                    else
                    {
                        components.m_indirectLightingController.indirectDiffuseLightingMultiplier.value = overrideAmbientIntensity * m_ambientIntensityMultiplier;
                    }
                }
                else
                {
        ...
        public void ApplyFogSettings(HDRPTimeOfDayComponents components, float time, out Color currrentFogColor, out float currentFogDistance)
        {
            ...
            components.m_fog.active = m_useFog;
            components.m_localVolumetricFog.enabled = m_useFog;
            components.m_fog.albedo.value = m_fogColor.Evaluate(time);
            components.m_fog.meanFreePath.value = m_fogDistance.Evaluate(time) / m_globalFogMultiplier;
            float fogHeight = m_fogHeight.Evaluate(time);
            ...
            components.m_fog.enableVolumetricFog.value = m_enableVolumetricFog;
            if (m_useDenoising)
            {
        ...
        public void ApplyShadowSettings(HDRPTimeOfDayComponents components, float time, OverrideDataInfo overrideData, bool isDay)
        {
            ...
            if (!overrideData.m_isInVolue)
            {
                if (transitionComplete)
                {
                    components.m_shadows.maxShadowDistance.value = Mathf.Lerp(components.m_shadows.maxShadowDistance.value, (m_shadowDistance.Evaluate(time) * shadowMultiplier), overrideData.m_transitionTime);
                }
                else
                {
                    components.m_shadows.maxShadowDistance.value = (m_shadowDistance.Evaluate(time) * shadowMultiplier);
                }
            }
            else
            {
