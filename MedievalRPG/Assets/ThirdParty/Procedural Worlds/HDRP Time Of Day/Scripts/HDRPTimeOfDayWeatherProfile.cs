    ...
    public class HDRPTimeOfDayWeatherProfileData
    {
        ...
        public bool ApplyWeather(HDRPTimeOfDayComponents components, bool isDay, bool overrideLightSource, float time, float duration)
        {
            ...
            if (ValidateAdvancedLighting())
            {
                ...
                components.m_indirectLightingController.indirectDiffuseLightingMultiplier.value = LerpFloat(m_startingData.m_ambientIntensity.Evaluate(m_lastTimeOfDayValue), m_weatherData.m_ambientIntensity.Evaluate(time) * m_weatherData.m_ambientIntensityMultiplier, duration);
            ...
            if (ValidateFog())
            {
                ...
                components.m_fog.meanFreePath.value = LerpFloat(m_startingData.m_fogDistance.Evaluate(m_lastTimeOfDayValue),m_weatherData.m_fogDistance.Evaluate(time) / m_weatherData.m_globalFogMultiplier, duration);
                ...
                components.m_fog.maximumHeight.value = LerpFloat(m_startingData.m_fogHeight.Evaluate(m_lastTimeOfDayValue), fogHeight * 2f, duration);
            ...
            if (ValidateShadows())
            {
                components.m_shadows.maxShadowDistance.value = LerpFloat(m_startingData.m_shadowDistance.Evaluate(m_lastTimeOfDayValue), m_weatherData.m_shadowDistance.Evaluate(time) * m_weatherData.m_shadowDistanceMultiplier, duration);
            ...
            if (ValidateClouds())
            {
                ...
                switch (m_weatherData.m_cloudLayerAChannel)
                {
                    ...
                    {
                        components.m_cloudLayer.layerA.opacityG.value = LerpFloat(m_startingData.m_cloudLayerAOpacityR.Evaluate(m_lastTimeOfDayValue), m_weatherData.m_cloudLayerAOpacityR.Evaluate(time), duration);
                    ...
                    {
                        components.m_cloudLayer.layerA.opacityB.value = LerpFloat(m_startingData.m_cloudLayerAOpacityR.Evaluate(m_lastTimeOfDayValue), m_weatherData.m_cloudLayerAOpacityR.Evaluate(time), duration);
                        components.m_cloudLayer.layerA.opacityR.value = 0f;
                        components.m_cloudLayer.layerA.opacityG.value = 0f;
                        components.m_cloudLayer.layerA.opacityA.value = 0f;
                        break;
                    ...
                    {
                        components.m_cloudLayer.layerA.opacityA.value = LerpFloat(m_startingData.m_cloudLayerAOpacityR.Evaluate(m_lastTimeOfDayValue), m_weatherData.m_cloudLayerAOpacityR.Evaluate(time), duration);
                        components.m_cloudLayer.layerA.opacityR.value = 0f;
                        components.m_cloudLayer.layerA.opacityG.value = 0f;
                        components.m_cloudLayer.layerA.opacityB.value = 0f;
                        break;
                ...
                switch (m_weatherData.m_cloudLayerBChannel)
                {
                    ...
                    case CloudLayerChannelMode.G:
                    {
                        components.m_cloudLayer.layerB.opacityG.value = LerpFloat(m_startingData.m_cloudLayerBOpacityR.Evaluate(m_lastTimeOfDayValue), m_weatherData.m_cloudLayerBOpacityR.Evaluate(time), duration);
                    ...
                    case CloudLayerChannelMode.B:
                    {
                        components.m_cloudLayer.layerB.opacityB.value = LerpFloat(m_startingData.m_cloudLayerBOpacityR.Evaluate(m_lastTimeOfDayValue), m_weatherData.m_cloudLayerBOpacityR.Evaluate(time), duration);
                        components.m_cloudLayer.layerB.opacityR.value = 0f;
                        components.m_cloudLayer.layerB.opacityG.value = 0f;
                        components.m_cloudLayer.layerB.opacityA.value = 0f;
                        break;
                    ...
                    case CloudLayerChannelMode.A:
                    {
                        components.m_cloudLayer.layerB.opacityA.value = LerpFloat(m_startingData.m_cloudLayerBOpacityR.Evaluate(m_lastTimeOfDayValue), m_weatherData.m_cloudLayerBOpacityR.Evaluate(time), duration);
                        components.m_cloudLayer.layerB.opacityR.value = 0f;
                        components.m_cloudLayer.layerB.opacityG.value = 0f;
                        components.m_cloudLayer.layerB.opacityB.value = 0f;
                        break;
