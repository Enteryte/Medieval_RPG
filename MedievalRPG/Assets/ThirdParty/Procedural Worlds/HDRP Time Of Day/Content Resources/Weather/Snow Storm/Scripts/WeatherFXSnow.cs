...
namespace ProceduralWorlds.HDRPTOD
{
    public class WeatherFXSnow: WeatherFXInstance, IHDRPWeatherVFX
    {
        ...
        public void DestroyInstantly()
        {
            ...
            {
                BaseSettings.SetSnowPowerValue(BaseSettings.LerpFromDuration(BaseSettings.m_weatherProfile.WeatherShaderData.m_snowShaderData.m_snowPower, BaseSettings.LerpShaderData.m_snowShaderData.m_snowPower));
                BaseSettings.SetSnowPowerOnTerrainValue(BaseSettings.LerpFromDuration(BaseSettings.m_weatherProfile.WeatherShaderData.m_snowShaderData.m_snowPowerOnTerrain, BaseSettings.LerpShaderData.m_snowShaderData.m_snowPowerOnTerrain));
                BaseSettings.SetSnowMinHeight(BaseSettings.LerpFromDuration(BaseSettings.m_weatherProfile.WeatherShaderData.m_snowShaderData.m_snowMinHeight, BaseSettings.LerpShaderData.m_snowShaderData.m_snowMinHeight));
            }
        ...
        private void FadeIn()
        {
            ...
            BaseSettings.SetSnowPowerValue(BaseSettings.LerpFromDuration(BaseSettings.LerpShaderData.m_snowShaderData.m_snowPower, BaseSettings.m_weatherProfile.WeatherShaderData.m_snowShaderData.m_snowPower));
            BaseSettings.SetSnowPowerOnTerrainValue(BaseSettings.LerpFromDuration(BaseSettings.LerpShaderData.m_snowShaderData.m_snowPowerOnTerrain, BaseSettings.m_weatherProfile.WeatherShaderData.m_snowShaderData.m_snowPowerOnTerrain));
            BaseSettings.SetSnowMinHeight(BaseSettings.LerpFromDuration(BaseSettings.LerpShaderData.m_snowShaderData.m_snowMinHeight, BaseSettings.m_weatherProfile.WeatherShaderData.m_snowShaderData.m_snowMinHeight));
